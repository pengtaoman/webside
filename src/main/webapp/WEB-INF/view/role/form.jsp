...
$(function() {
    ...
    var validData = [{id : "1", text: "企业端"},{id : "0", text: "管理端"},{id : "3", text: "注册用户"}];
	$("#roleType").select2({
		  data: validData,
		  placeholder:'请选择',
		  //allowClear:true
		});
	var type = "${roleEntity.type }";
	
	if(type == undefined || type == '') {
		type = 1;
	}
	
	$("#roleType").val(type).trigger("change");
});
</script>
	...
	<div class="col-xs-12">
		...
		<c:if test="${!empty roleEntity}">
		   ...
		   <div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-sm-1 no-padding-right" for="type">角色类型</label>
				<div class="col-sm-10">
					<div class="clearfix">
						<select class="form-control" id="roleType" name="type"></select>
					</div>
				</div>
			</div>
		   <div class="form-group">
