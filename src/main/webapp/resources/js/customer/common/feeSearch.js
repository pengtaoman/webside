var dtGridColumnsFeeSearchPanel = [ {
    id : 'code',
    title : '序号',
    type : 'string',
...
var dtGridOptionSearchPanel = {
    ...
    columns : dtGridColumnsFeeSearchPanel,
...
var FeeSearchPanel = {
    ...
    GetPanelHtml : function() {
    	var html = '<div class="col-xs-12 widget-container-col ui-sortable"><div class="widget-header">'
       	for (var k = 0, length = FeeSearchPanel.SelectFields.length; k < length; k++) {
       		html += '<div class="col-sm-1" style="margin-top: 5px;'+FeeSearchPanel.SelectFields[k].wd+'"><label >';
       		html += FeeSearchPanel.SelectFields[k].name;
       		html += '</label></div><div class="'+ FeeSearchPanel.SelectFields[k].col+ '"><select class="form-control" id="';
       		html += FeeSearchPanel.SelectFields[k].id;
       		html += '"></select></div>';
       	}
    	
       	html = html + '<div class="col-sm-1"><span class="input-group-btn">';
        ...
        html = html + '<button id="btnSearchHide33" style="margin-left: 5px" class="btn btn-success btn-sm" type="button"><i class="fa fa-angle-double-up"></i>&nbsp;收起</button>';
      	...
      	html = html + '<div class="widget-body" style="display: block;">'; 
      	html = html + '<div class="widget-main padding-6 no-padding-left no-padding-right">'; 
      	...
      	html = html + '	<div id="dtGridContainer33" class="dlshouwen-grid-container"></div>'; 
      	html = html + '	<div id="dtGridToolBarContainer33" class="dlshouwen-grid-toolbar-container"></div>'; 
		...
		$("#selectAccuracy33").on("select2:select", function (e) { 
    	 ...
    	 $("#btnSearch33").click(function(){
    		 if(gridObj != undefined) {
    			 FeeSearchPanel.ClickSearch(gridObj);
