...
$(document).ready(function() {
	...
	$("#registerAccept").change(function() { 
		if ($("#registerAccept")[0].checked) {
			$("#rgstbutton").removeAttr("disabled");
		} else {
			$("#rgstbutton").attr("disabled", true);
		}
	});
});
function registerClick() {
	if ($("#registerAccept")[0].checked) {
		...
		layer.alert('请先接受用户协议', {icon : 5,shift : 6,time : 0});
	}
}
</script>
</head>
				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center" style="margin-top:150px;">
							<h1>
								<span style='color:white'>管理平台</span>
							</h1>
						</div>
...
<!-- 											<i class="ace-icon fa fa-coffee blue"></i> -->
										...
										<form id="loginform" name="loginform"
											...
											<fieldset>
												...
												<label class="block clearfix"> 
													<input style="display:none;" value="11" id="captcha" name="captcha" type="text" class="form-control" placeholder="验证码" style="width:60%;float:left;"/>
												<img style="display:none;" id="kaptchaImage" src="${ctx }/captcha.html" style="cursor:pointer; margin-left:10px;" title="点击更换"/>  
												</label>
										...
										<form id="registerform" name="registerform" action="${ctx }/register.html"
											...
											<fieldset>
												...
												<div class="clearfix">
													...
													<button id="rgstbutton" disabled="disabled" type="button" onclick="registerClick();"
