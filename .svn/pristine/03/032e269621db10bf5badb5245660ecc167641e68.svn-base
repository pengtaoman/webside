...
function onSaveClick() {
	$('#userInfoForm').submit();
	$('#header_username').html($('#userName').val());
}
</script>
<style type="text/css">
.noform{
...
<div class="center">
	<div class="form-group">
					...
					<button id="btnAdd" type="button" onclick="javascript:onSaveClick()" class="btn btn-success btn-sm"  style="margin-left: 13px; display: none;">
