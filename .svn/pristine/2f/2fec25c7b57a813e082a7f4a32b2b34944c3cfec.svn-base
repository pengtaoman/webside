...
public class ShiroAuthenticationManager {
	...
	public static void refreshUserSession(UserEntity entity) {
		ShiroAuthenticationManager.setSessionAttribute(ShiroUtils.USERSESSION, entity);
	}
	/**
	 * 获取用户id
	 * 
	...
	public static Long getCompanyId() {
		return getUserEntity() == null ? null : getUserEntity().getCompanyId();
	}
	...
	public static String getCompanyName() {
		return getUserEntity() == null ? null : getUserEntity().getCompanyName();
	}
	...
	public static Long[] getCompanyIds() {
		return getUserEntity() == null ? null : getUserEntity().getCompanyIds();
	}
	...
	public static boolean isAdminUser() {
		...
		if(entity != null 
				&& (ShiroAuthenticationManager.getUserEntity().getRole().getType() == RoleType.ROLE_admin
				|| ShiroAuthenticationManager.getUserEntity().getRole().getType() == RoleType.ROLE_SUPER)) {
			return true;
		}
		//TODO ji
		return false;
