...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/customer/business/organlist.js"></script>

<div class="page-header">
	<shiro:hasPermission name="organ:Modify">
		<button id="btnAdd" type="button" onclick="webside.common.addModel('/organ/addUI.html')" class="btn btn-primary btn-sm">
			<i class="fa fa-user-plus"></i>&nbsp;添加
		</button>
		<button id="btnAddCopy" type="button" onclick="webside.common.editModel('/organ/addCopyUI.html')" class="btn btn-primary btn-sm">
			<i class="fa fa-user-plus"></i>&nbsp;复制
		</button>
		<button id="btnEdit" type="button" onclick="webside.common.editModel('/organ/editUI.html')"	class="btn btn-success btn-sm">
			<i class="fa fa-pencil-square-o"></i>&nbsp;编辑
		</button>
		<button id="btnDel" type="button" onclick="webside.common.delBatchModel('/organ/deleteBatch.html', customSearch)" class="btn btn-danger btn-sm">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header"  style="display: none;">
				<h4 class="widget-title lighter">检测机构列表</h4>
