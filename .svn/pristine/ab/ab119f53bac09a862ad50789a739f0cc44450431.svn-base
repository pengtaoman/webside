...
<script type="text/javascript">
	$(function() {
		FileHelper.initEntrustTemplate($("#uploadDiv"), afterUploadInquiry);
			var data = {key : 'EntrustTemplate'};
	...
	<div class="col-xs-12">
		<form id="form1" class="form-horizontal" role="form" method="post">
			<div class="form-group">
				<label class="control-label col-sm-1 no-padding-right" for="id">委托单模板</label>
				<div class="col-sm-2">
